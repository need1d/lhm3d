package com.lhm3d.materialobjects
{
	...
	public class CLTexEnvBumpHalo3DObject extends Base3DObject
	{
		...
		public function CLTexEnvBumpHalo3DObject(_haloHardness:Number,_haloAmount:Number,_envAmount:Number,_textureIndex:int, _textureIndex2:int,_textureIndexBump:int, _vertexLayer:Vector.<Number>, 
		...
		public override function renderWithMatrix(_mat:Matrix3D):void  {
			...
			Globals.context3D.setProgramConstantsFromVector(Context3DProgramType.FRAGMENT, 7, Vector.<Number>([1.0, 1.0, 1.0, 0.0])); //for the max value
